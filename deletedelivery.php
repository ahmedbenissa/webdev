...
{
	echo "+";
$classdeliverycore=new deliverycore();
$classdeliverycore->deletedelivery($_POST['id']);
}
else
{
	echo "verify";
					...
					<section class="section">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">supprimer une   Livraison</li>
							</ol>
						</div>
						<!--page-header closed-->
                        ...
                        <!--row open-->
							<div class="row">
							 <a href="displaydeliveries.php">Consulter les  livraison</a></br></br>
