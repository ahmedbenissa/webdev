...
class driver
{
	...
	function __construct($id_driver,$name_lastname,$date_available)
	    {
...
if (isset($_POST['id_driver']) and isset($_POST['name_lastname'])and isset($_POST['date_available'])){
$classdriver=new driver($_POST['id_driver'],$_POST['name_lastname'],$_POST['date_available']);
$deliverydrivercore1=new deliverydrivercore();
$deliverydrivercore1->adddeliverydriver($classdriver);
}
...
<li class="slide">
							<a class="side-menu__item"  data-toggle="slide" href="principal.php"><i class="side-menu__icon fa fa-laptop"></i><span class="side-menu__label">Livreur</span></a>
							<ul class="slide-menu">
				...
				<div class="app-content">
					<section class="section">
						...
						<div class="page-header">
							...
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#" class="text-light-color">Livreur</a></li>
								<li class="breadcrumb-item active" aria-current="page">ajouter un  Livreur</li>
							</ol>
						</div>
						<!--page-header closed-->
                        ...
                        <!--row open-->
							<div class="row">
							 <a href="displaydrivers.php">Consulter les  livreurs</a></br></br>
							 
							</div>
						<!--row closed-->
						<a href="Supplier.html">Retour</a><br><br>
